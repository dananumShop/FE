  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center">
        <div className="*:font-medium mt-80 max-sm:mt-32">
          <span className="text-5xl">로그인</span>
        </div>
        <div className="flex flex-col py-4 items-center max-w-full">
          {/* 회원로그인 div */}
          <span className="border-b-2 border-black py-1 w-full"></span>
          <div className="w-96">
            <form className="">
